...
# master01 ip address
export K8SHA_IP1=192.168.63.2

# master02 ip address
export K8SHA_IP2=192.168.63.3

# master03 ip address
export K8SHA_IP3=192.168.63.6


# master01 hostname
export K8SHA_HOSTNAME1=cs-hsuhw-k8sm1

# master02 hostname
export K8SHA_HOSTNAME2=cs-hsuhw-k8sm2

# master03 hostname
export K8SHA_HOSTNAME3=cs-vsudoc-k8sm4
